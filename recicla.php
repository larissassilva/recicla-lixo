...
<div class="container">
	...
	<div class="table-responsive">
		<table class="table table-hover table-striped width-full" id="tabelaRecicla">
			<thead>
				<tr>
					<th>ID</th>
					<th>Material</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Cadastrar Reciclagem</h4>
			</div>
						...
						<div class="">
							<div class="form-group">
								...
								<div class="modal2">
									...
									<select id="idfornecedor" class="idfornecedor" name="idfornecedor">
										<option value=""></option>
										<?php

										   $dao = new DAOFornecedor();
    $lista= $dao->listarEspecial('SELECT idfornecedor, nome  FROM fornecedor ORDER BY nome');
                                            foreach ($lista as $value):
                                                echo '<option value='.$value->idfornecedor.'>'.$value->nome.'</option>';
                                            endforeach;
                                        ?>
									</select>
    ...
    $lista= $dao->listarEspecial('SELECT id, tipo  FROM tipo ORDER BY tipo');
									...
									<select id="material" class="material" name="material">
										...
										<?php
										   ...
										   $dao = new DAOMaterial();
    $lista= $dao->listarEspecial('SELECT idnome_elixo, nome  FROM material ORDER BY nome');
                                            foreach ($lista as $value):
                                                echo '<option value='.$value->idnome_elixo.'>'.$value->nome.'</option>';
                                            endforeach;
                                        ?>
									</select>
										

									<label for="country">Funciona</label>
									<select id="funciona" class="funiona" name="funciona">
										<option value=""></option>
									...
									<input type="text" id="valorcompra" class="valorcompra" name="valorcompra" placeholder="Se for doação digite 0.0">

									<label>Peso</label>
									<input type="text" id="peso" class="peso" name="peso" placeholder="Digite dessa forma 0.0">
				...
				<div class="row">
                        <div class="modal-footer">
                            <div class="col-lg-12">
                                ...
                                <button id="salvar" type="button" class="button2">Salvar</button>
                            </div>
                        </div>
                    </div>
			</form>
						...
						<div class="">
							<div class="form-group">
								...
								<div class="modal2">
									...
									<label for="fname">Data Cadastro</label>
									<input type="text" id="data" class="data" name="data" placeholder="">
									

									<label for="country">Fornecedor</label>
									<select id="fornecedor" class="fornecedor" name="fornecedor">
...
<!-- 										<option value="0"></option>
    ...
    $lista= $dao->listarEspecial('SELECT idnome_elixo, nome  FROM material ORDER BY nome');
									...
									<labels>Funciona</label>
									<select id="funciona" class="funciona" name="funciona">
										<option value=""></option>
										<option value="SIM">SIM</option>
										<option value="NÃO">NÃO</option>
									</select>

									<label for="fname">Valor da Compra</label>
									<input type="text" id="valorcompra" class="valorcompra" name="valorcompra" placeholder="Se for doação digite 0.0">

									<label for="fname">Peso</label>
									<input type="text" id="peso" class="peso" name="peso" placeholder="Digite dessa forma 0.0">

									<label for="fname">Valor da Venda</label>
									<input type="text" id="valorvenda" class="valorvenda" name="valorcompra" placeholder="Doação digite 0.0">
								</div>
							</div>
						</div>
					</div>
